...
public class AppKeys {
    ...
    public static final String API_SPIDER = "api_spider";
    public static final String SOURCE_BEAN_LIST = "source_bean_list";
    public static final String PARSE_BEAN_LIST = "parse_bean_list";
    public static final String API_HISTORY = "api_history";
    public static final String VIP_PARSE_FLAGS = "vip_parse_flags";
